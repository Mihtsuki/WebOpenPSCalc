...
- **The masteries panel now shows Blade Mastery.** The PS Knight rework removed both
  ...
  engine had the merge all along, but the panel still offered the old pair under
  vanilla names. Every sword-wielding job now sees the single Blade Mastery —
  Swordsman and Knight, and likewise Rogues (where it still enables sword Double
  Attack) and Super Novices. Builds saved with the old masteries migrate
  automatically, so no shared build loses damage.
...
- **A multi-hit swing now deals exactly what its popups show.** The week's last open
  question on Double Attack, settled by ruling: a swing whose raw arithmetic gives 397
  ...
  reads "396 (2 × 198)" and ranges read "450–480 (2 × 225–240)".
